  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col">
      <div className="relative w-full aspect-[3/4] overflow-hidden bg-gray-100">
          ...
          {product.tag && (
            <span className="absolute top-3 left-3 bg-primary text-white text-xs font-semibold px-3 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
          {product.tag}
        </span>
        )}
      </div>
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <a
          ...
          className="mt-3 inline-flex items-center justify-center gap-2 bg-primary text-white font-semibold text-sm px-4 py-2.5 rounded-lg hover:bg-opacity-90 hover:shadow-md transition-all duration-200 w-full"
        >
